...
namespace Views.Migrations
{
    ...
    [Migration("20230526201433_ContactFormMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Views.Models.Entities.ContactFormEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Views.Models.Identity.ProfileData", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Views.Models.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Views.Models.Entities.ProductsCategory", b =>
                {
                    ...
                    b.HasOne("Views.Models.Entities.ProductEntity", "Product")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("Views.Models.Identity.ProfileData", b =>
                {
                    b.HasOne("Views.Models.Identity.AppUser", "User")
                        .WithMany()
